function [cost, a, hp] = deepPreFeedforward(W, b, data, LAMBDA, p, BETA, noiseRatio, labels, softmaxModel, lossFunc)
	l = 1 : size(labels, 1);
	labels = (full(sparse(l, labels, 1.0)))';
	[cost, a, hp] = preFeedforward(W, b, 'traditional', data, LAMBDA, p, BETA, noiseRatio, labels,...
